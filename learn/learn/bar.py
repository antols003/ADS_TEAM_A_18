...
def generate_video_response(text_response):
    ...
    video = ImageClip("C:\\Users\\student.MCC\\Downloads\\learn\\learn\\path_to_avatar_0.jpg").set_duration(audio.duration) # Replace 'path_to_avatar_1.jpg' with your image path
